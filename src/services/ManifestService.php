<?php
/**
 * Plugin Manifest for Craft CMS 3.x plugins
 *
 * Plugin Manifest is the conduit between Craft CMS plugins and webpack, with manifest.json &
...
namespace nystudio107\pluginmanifest\services;
